...
const classicFormattingList: Record<string, string> = {
  ...
  'Peach Circuit (Mario Kart: Super Circuit)': 'GBA Peach Circuit',
  'Shy Guy Beach (Mario Kart: Super Circuit)': 'GBA Shy Guy Beach',
  'Riverside Park (Mario Kart: Super Circuit)': 'GBA Riverside Park',
  'Bowser Castle (Mario Kart: Super Circuit)': 'GBA Bowser Castle',
  'Cheese Land (Mario Kart: Super Circuit)': 'GBA Cheese Land',
  'Ribbon Road (Mario Kart: Super Circuit)': 'GBA Ribbon Road',
  'Yoshi Desert (Mario Kart: Super Circuit)': 'GBA Yoshi Desert',
  'Rainbow Road (Mario Kart: Super Circuit)': 'GBA Rainbow Road',
  'Luigi Circuit (Mario Kart: Double Dash!!)': 'GCN Luigi Circuit',
  'Baby Park (Mario Kart: Double Dash!!)': 'GCN Baby Park',
  'Dry Dry Desert (Mario Kart: Double Dash!!)': 'GCN Dry Dry Desert',
  'Mushroom Bridge (Mario Kart: Double Dash!!)': 'GCN Mushroom Bridge',
  'Sherbet Land (Mario Kart: Double Dash!!)': 'GCN Sherbet Land',
  'Bowser\'s Castle (Mario Kart: Double Dash!!)': 'GCN Bowser\'s Castle',
  'Rainbow Road (Mario Kart: Double Dash!!)': 'GCN Rainbow Road',
  ...
  'Toad Circuit (Mario Kart 7)': '3DS Toad Circuit',
  'Daisy Hills (Mario Kart 7)': '3DS Daisy Hills',
  'Melody Motorway (Mario Kart 7)': '3DS Melody Motorway',
  'Alpine Pass (Mario Kart 7)': '3DS Alpine Pass',
  'Piranha Plant Pipeway (Mario Kart 7)': '3DS Piranha Plant Pipeway',
  'DK Jungle (Mario Kart 7)': '3DS DK Jungle',
  'Rosalina\'s Ice World (Mario Kart 7)': '3DS Rosalina\'s Ice World',
  'Rainbow Road (Mario Kart 7)': '3DS Rainbow Road',
  'Tokyo Blur (Mario Kart Tour)': 'Tour Tokyo Blur',
  'Vancouver Velocity (Mario Kart Tour)': 'Tour Vancouver Velocity',
  'Los Angeles Laps (Mario Kart Tour)': 'Tour Los Angeles Laps',
  'Merry Mountain (Mario Kart Tour)': 'Tour Merry Mountain',
  'Ninja Hideaway (Mario Kart Tour)': 'Tour Ninja Hideaway',
  'Singapore Speedway (Mario Kart Tour)': 'Tour Singapore Speedway',
  'Bangkok Rush (Mario Kart Tour)': 'Tour Bangkok Rush',
  'Piranha Plant Pipeline (Mario Kart Tour)': 'Tour Piranha Plant Pipeline',
}
